...
const DEFAULT_SYSTEM_PROMPT = [
  ...
  '- Choose the label by semantic meaning, not by spelling, shared prefixes, or surface-form similarity.',
  '- If the exact concept is not an allowed label, compare ALL labels and choose the semantically closest one.',
  '- Interpret synonyms, translations, colloquial terms, and closely related narrower or broader terms before comparing labels.',
